    ...
    <div class="admin-request-index">
        ...
        <div class="tab-group">
            <div class="index-tab {{ request('tab','pending')==='pending'?'active':''}}">
                <a class="index__link "href="{{route('request.list',['tab'=>'pending'])}}">承認待ち</a>
            </div>
            <div class="index-tab {{ request('tab')==='approved'?'active':''}}">
                <a class="index__link "href="{{route('request.list',['tab'=>'approved'])}}">承認済み</a>
            </div>
        </div>
